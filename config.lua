Config = {
	Prefix = '^5[^1Deadssentials^5] ^3',
	ScreenAffects = {
		AnnounceCommand = "announce",
        AcePermission = "Deadssentials.Announce", --The ace permission need to run the AnnounceCommand.
    ...
    AOPSystem = {
        ...
        AOP_AcePermission = "Deadssentials.AOP", --The ace permission need to run the AOPCommand.
    },
    ReviveSystem = {
        ...
        ReviveOthersAcePermission = "Deadssentials.Revive",
        ...
        BypassReviveAcePermission = "Deadssentials.Bypass.Revive",
        BypassRespawnAcePermission = "Deadssentials.Bypass.Respawn",
        RespawnLocations = {
            DefaultLocation = {
    ...
    Misc = {
        ...
        PT = "pt",
        PeacetimeAcePermission = "Deadssentials.PeaceTime", --The ace permission required to run PT or Peacetime command.
    },
    Displays = {
		[' | Discord'] = {
			x = .800,
